...
#define TEST_ASSERT_EQUAL_MOTORINFO(name,delta,df,err,Dostepping,isReferencing,start,end,MotorPin,Motorinfo,index) \
                          testAssertEqualMotorInfo(name,delta,df,err,Dostepping,isReferencing,start,end,MotorPin,Motorinfo,index,__LINE__)
